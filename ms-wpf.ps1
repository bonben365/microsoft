...
<Window x:Class="ms.MainWindow"
        ...
        mc:Ignorable="d"
        Title="Free Microsoft Products Activation - www.msgang.com" Height="441" Width="529" Background="#FFFDF2F2" WindowStartupLocation="CenterScreen">
