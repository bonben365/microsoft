...
if (($dstatus | Select-String -SimpleMatch "Office19VisioPro" | Measure-Object).Count -gt 0 -and $matchingOffice2019Retail -gt 0 ) {$licName = 'VisioPro2019VL*'; $2019kmskey = '9BGNQ-K37YR-RQHF2-38RQ3-7VCBB'} #For Office 2019 Standalone (Visio Pro)
...
if (($dstatus | Select-String -SimpleMatch "Office21Professional" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'ProPlus2021VL*'; $2021kmskey = 'FXYTK-NJJ8C-GB6DW-3DYQT-6F7TH'} #For Office 2021 Retail (Pro)
if (($dstatus | Select-String -SimpleMatch "Office21ProPlus" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'ProPlus2021VL*'; $2021kmskey = 'FXYTK-NJJ8C-GB6DW-3DYQT-6F7TH'} #For Office 2021 Retail (Pro) (MSDN)
if (($dstatus | Select-String -SimpleMatch "Office21Standard" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'Standard2021VL*'; $2021kmskey = 'KDX7X-BNVR8-TXXGX-4Q7Y8-78VT3'} #For Office 2021 Retail (Standard)
if (($dstatus | Select-String -SimpleMatch "Office21ProjectPro" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'ProjectPro2021VL*'; $2021kmskey = 'FTNWT-C6WBT-8HMGF-K9PRX-QV9H8'} #For Office 2021 Standalone (Project Pro)
if (($dstatus | Select-String -SimpleMatch "Office21ProjectStd" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'ProjectStd2021VL*'; $2021kmskey = 'J2JDC-NJCYY-9RGQ4-YXWMH-T3D4T'} #For Office 2021 Standalone (Project Standard)
if (($dstatus | Select-String -SimpleMatch "Office21VisioPro" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'VisioPro2021VL*'; $2021kmskey = 'KNH8D-FGHT4-T8RK3-CTDYJ-K2HT4'} #For Office 2021 Standalone (Visio Pro)
if (($dstatus | Select-String -SimpleMatch "Office21VisioStd" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'VisioStd2021VL*'; $2021kmskey = 'MJVNY-BYWPY-CWV6J-2RKRT-4M8QG'} #For Office 2021 Standalone (Visio Standard)
if (($dstatus | Select-String -SimpleMatch "Office21Word" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'Word2021VL*'; $2021kmskey = 'TN8H9-M34D3-Y64V9-TR72V-X79KV'} #For Office 2021 Standalone (Word)
if (($dstatus | Select-String -SimpleMatch "Office21Excel" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'Excel2021VL*'; $2021kmskey = 'NWG3X-87C9K-TC7YY-BC2G7-G6RVC'} #For Office 2021 Standalone (Excel)
if (($dstatus | Select-String -SimpleMatch "Office21PowerPoint" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'PowerPoint2021VL*'; $2021kmskey = 'TY7XF-NFRBR-KJ44C-G83KF-GX27K'} #For Office 2021 Standalone (PowerPoint)
if (($dstatus | Select-String -SimpleMatch "Office21Outlook" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'Outlook2021VL*'; $2021kmskey = 'C9FM6-3N72F-HFJXB-TM3V9-T86R9'} #For Office 2021 Standalone (Outlook)
if (($dstatus | Select-String -SimpleMatch "Office21Access" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'Access2021VL*'; $2021kmskey = 'WM8YG-YNGDD-4JHDC-PG3F4-FC4T4'} #For Office 2021 Standalone (Access)
if (($dstatus | Select-String -SimpleMatch "Office21Publisher" | Measure-Object).Count -gt 0 -and $matchingOffice2021Retail -gt 0 ) {$licName = 'Publisher2021VL*'; $2021kmskey = '2MW9D-N4BXM-9VBPG-Q7W6M-KFBGQ'} #For Office 2021 Standalone (Publisher)

if ($matchingOffice2021Retail -gt 0 ) { Office2021-V2R }
...
if (($dstatus | Select-String -SimpleMatch "Office16Professional" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'ProPlusVL*'; $2016kmskey = 'XQNVK-8JYDB-WJ9W3-YJ8YR-WFG99'} #For Office 2016 Retail (Pro)
if (($dstatus | Select-String -SimpleMatch "Office16ProPlus" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'ProPlusVL*'; $2016kmskey = 'XQNVK-8JYDB-WJ9W3-YJ8YR-WFG99'} #For Office 2016 Retail (Pro) (MSDN)
if (($dstatus | Select-String -SimpleMatch "Office16Standard" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'StandardVL*'; $2016kmskey = 'JNRGM-WHDWX-FJJG3-K47QV-DRTFM'} #For Office 2016 Retail (Standard)
if (($dstatus | Select-String -SimpleMatch "Office16ProjectPro" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'ProjectProVL*'; $2016kmskey = 'YG9NW-3K39V-2T3HJ-93F3Q-G83KT'} #For Office 2016 Standalone (Project Pro)
if (($dstatus | Select-String -SimpleMatch "Office16ProjectStd" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'ProjectStdVL*'; $2016kmskey = 'GNFHQ-F6YQM-KQDGJ-327XX-KQBVC'} #For Office 2016 Standalone (Project Standard)
if (($dstatus | Select-String -SimpleMatch "Office16VisioPro" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'VisioProVL*'; $2016kmskey = 'PD3PC-RHNGV-FXJ29-8JK7D-RJRJK'} #For Office 2016 Standalone (Visio Pro)
if (($dstatus | Select-String -SimpleMatch "Office16VisioStd" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'VisioStdVL*'; $2016kmskey = '7WHWN-4T7MP-G96JF-G33KR-W8GF4'} #For Office 2016 Standalone (Visio Standard)
if (($dstatus | Select-String -SimpleMatch "Office16Word" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'WordVL*'; $2016kmskey = 'WXY84-JN2Q9-RBCCQ-3Q3J3-3PFJ6'} #For Office 2016 Standalone (Word)
if (($dstatus | Select-String -SimpleMatch "Office16Excel" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'ExcelVL*'; $2016kmskey = '9C2PK-NWTVB-JMPW8-BFT28-7FTBF'} #For Office 2016 Standalone (Excel)
if (($dstatus | Select-String -SimpleMatch "Office16PowerPoint" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'PowerPointVL*'; $2016kmskey = 'J7MQP-HNJ4Y-WJ7YM-PFYGF-BY6C6'} #For Office 2016 Standalone (PowerPoint)
if (($dstatus | Select-String -SimpleMatch "Office16Outlook" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'OutlookVL*'; $2016kmskey = 'R69KK-NTPKF-7M3Q4-QYBHW-6MT9B'} #For Office 2016 Standalone (Outlook)
if (($dstatus | Select-String -SimpleMatch "Office16Access" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'AccessVL*'; $2016kmskey = 'GNH9Y-D2J4T-FJHGG-QRVH7-QPFDW'} #For Office 2016 Standalone (Access)
if (($dstatus | Select-String -SimpleMatch "Office16Publisher" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'PublisherVL*'; $2016kmskey = 'F47MM-N3XJP-TQXJ9-BP99D-8837K'} #For Office 2016 Standalone (Publisher)

if ($matchingOffice2016Retail -gt 0 ) { Office2016-V2R }
