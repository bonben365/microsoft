...
$convertltsc2019 = {
   ...
   Write-Host
   $version = (Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion").ProductName
   New-Item -Path $env:temp\temp\ltsc2019 -ItemType Directory -Force
   Set-Location $env:temp\temp\ltsc2019
    
   $uri = 'https://raw.githubusercontent.com/bonben365/microsoft/main/Files/ltsc2019.zip'
   (New-Object Net.WebClient).DownloadFile($uri, "$env:temp\temp\ltsc2019\ltsc2019.zip")
    
   Expand-Archive .\ltsc2019.zip -DestinationPath . -Force | Out-Null
   ...
   #Cleanup
   Set-Location $env:temp
   Remove-Item -Path $env:temp\temp\ltsc2019 -Recurse -Force
}
...
$convertltsc2021 = {
   ...
   Write-Host
   $version = (Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion").ProductName
   New-Item -Path $env:temp\temp\ltsc2021 -ItemType Directory -Force
   Set-Location $env:temp\temp\ltsc2021
    
   $uri = 'https://raw.githubusercontent.com/bonben365/microsoft/main/Files/ltsc2021.zip'
   (New-Object Net.WebClient).DownloadFile($uri, "$env:temp\temp\ltsc2021\ltsc2021.zip")
    
   Expand-Archive .\ltsc2021.zip -DestinationPath . -Force | Out-Null
   ...
   #Cleanup
   Set-Location $env:temp
   Remove-Item -Path $env:temp\temp\ltsc2021 -Recurse -Force
}
...
$convertsrv2016 = {
   ...
   Write-Host
   $version = (Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion").ProductName
   New-Item -Path $env:temp\temp\srv2016 -ItemType Directory -Force
   Set-Location $env:temp\temp\srv2016
    
   $uri = 'https://raw.githubusercontent.com/bonben365/microsoft/main/Files/srv2016.zip'
   (New-Object Net.WebClient).DownloadFile($uri, "$env:temp\temp\srv2016\srv2016.zip")
    
   Expand-Archive .\srv2016.zip -DestinationPath . -Force | Out-Null
...
$convertsrv2019 = {
   ...
   Write-Host
   $version = (Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion").ProductName
   New-Item -Path $env:temp\temp\srv2019 -ItemType Directory -Force
   Set-Location $env:temp\temp\srv2019
    
   $uri = 'https://raw.githubusercontent.com/bonben365/microsoft/main/Files/srv2019.zip'
   (New-Object Net.WebClient).DownloadFile($uri, "$env:temp\temp\srv2019\srv2019.zip")
    
   Expand-Archive .\srv2019.zip -DestinationPath . -Force | Out-Null
   ...
   #Cleanup
   Set-Location $env:temp
   Remove-Item -Path $env:temp\temp\srv2019 -Recurse -Force
}
...
$convertsrv2022 = {
   ...
   Write-Host
   $version = (Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion").ProductName
   New-Item -Path $env:temp\temp\srv2022 -ItemType Directory -Force
   Set-Location $env:temp\temp\srv2022
    
   $uri = 'https://raw.githubusercontent.com/bonben365/microsoft/main/Files/srv2022.zip'
   (New-Object Net.WebClient).DownloadFile($uri, "$env:temp\temp\srv2022\srv2022.zip")
    
   Expand-Archive .\srv2022.zip -DestinationPath . -Force | Out-Null
   ...
   #Cleanup
   Set-Location $env:temp
   Remove-Item -Path $env:temp\temp\srv2022 -Recurse -Force
}
...
############################################## Start group boxes
   ...
   $groupboxsrv2016.Location = New-Object System.Drawing.Size(350,10) 
   $groupboxsrv2016.size = New-Object System.Drawing.Size(170,200) 
   ...
   $groupboxsrv2019.Location = New-Object System.Drawing.Size(530,10) 
   $groupboxsrv2019.size = New-Object System.Drawing.Size(170,200) 
   ...
   $groupboxsrv2022.Location = New-Object System.Drawing.Size(710,10) 
   $groupboxsrv2022.size = New-Object System.Drawing.Size(170,200) 
   ...
   $groupboxeval.size = New-Object System.Drawing.Size(210,100) 
   ...
   $groupbox10LTSCeval.size = New-Object System.Drawing.Size(300,200) 
